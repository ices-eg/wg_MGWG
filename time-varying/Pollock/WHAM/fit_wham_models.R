...
# source("/home/bstock/Documents/wg_MGWG/time-varying/Pollock/WHAM/fit_wham_models.R")
...
# # get m2 par to start m2-m5
# m2 <- readRDS("/home/bstock/Documents/wham/sandbox/ices_selectivity/Pollock/run3_fix8/m2.rds")
...
# for(m in 1:5){	# only logistic
	...
	# 	input$par$sel_repars[1,1] <- m2_sel_repars[1,1]
	# }	
...
# lapply(mods1[1:5], function(x) x$parList$logit_selpars)
