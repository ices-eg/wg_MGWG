...
# Save data files to use in the vignette
# cat(capture.output(check_convergence(m1)), sep='\n')
vign1_m1_conv <- capture.output(check_convergence(m1))
vign1_m2_conv <- capture.output(check_convergence(m2))
vign1_m3_conv <- capture.output(check_convergence(m3))
vign1_m4_conv <- capture.output(check_convergence(m4))
save(vign1_m1_conv, file="/home/bstock/Documents/wham/data/vign1_m1_conv.RData")
save(vign1_m2_conv, file="/home/bstock/Documents/wham/data/vign1_m2_conv.RData")
save(vign1_m3_conv, file="/home/bstock/Documents/wham/data/vign1_m3_conv.RData")
save(vign1_m4_conv, file="/home/bstock/Documents/wham/data/vign1_m4_conv.RData")

vign1_res <- compare_wham_models(mods, fname="model_comparison", sort=TRUE)
save(vign1_res, file="/home/bstock/Documents/wham/data/vign1_res.RData")

# make output plots from m4
