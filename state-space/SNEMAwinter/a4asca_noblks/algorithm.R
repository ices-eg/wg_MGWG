...
# run model
#====================================================================
qmod <- list(~s(age, k=5) + year, ~s(age, k=3), ~s(age, k=3) + year)
fmod <- ~te(age, year, k = c(4, 12)) + s(age, k = 5)
...
#====================================================================
stk.retro <- retro(stk, idxs, retro=7, k=c(age=4, year=12, age2=5), ftype="te", qmodel=qmod, srmodel=srmod)
