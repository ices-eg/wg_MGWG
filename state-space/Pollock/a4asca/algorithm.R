...
# run model
#====================================================================
qmod <- list(~s(age, k=4, by=breakpts(year, 2008)), ~s(age, k=4, by=breakpts(year, 2008)))
...
#====================================================================
stk.retro <- retro(stk, idxs, retro=7, k=c(age=5, year=17, age2=5), ftype="te", qmodel=qmod, srmodel=srmod)
