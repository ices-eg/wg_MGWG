...
#====================================================================
setwd('../')
idxs <- readFLIndices('GOMHADDOCK_survey.dat')
...
#====================================================================
stk.retro <- retro(stk, idxs, retro=7, k=c(age=8, year=20), ftype="sep", qmodel=qmod, srmodel=srmod)
