...
d<-read.asap3.dat.fn(paste0("../ASAP/RunBupdate_NoLC_Final_FixFall.DAT"))
...
dw <- cw ##read.ices(paste0(prefix,"dw.dat"))
lw <- cw ##read.ices(paste0(prefix,"lw.dat"))
...
lf <- pf/pf ##read.ices(paste0(prefix,"lf.dat"))
surveys <- read.ices(paste0(prefix,"survey.dat"))



for(i in 1:length(surveys)){
    sel <- d2$data$use_index_paa[,i]
