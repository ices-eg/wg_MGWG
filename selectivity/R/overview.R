...
stdline(nafo_2j3kl$Fmort,    lwd, col[6], lty=2)  # moratorium
stdline(nafo_3m$Fmort,       lwd, col[7])
stdline(nafo_3no$Fmort,      lwd, col[8], lty=2)  # moratorium
stdline(ne_arctic$Fmort,     lwd, col[9], from=4, to=14)
stdline(north_sea$Fmort,     lwd, col[10])
stdline(norway$Fmort,        lwd, col[11])
stdline(s_celtic$Fmort,      lwd, col[12])
stdline(w_baltic$Fmort,      lwd, col[13])
...
stdline(nafo_2j3kl$wcatch,    lwd, col[6], lty=2)
stdline(nafo_3m$wcatch,       lwd, col[7])
stdline(nafo_3no$wcatch,      lwd, col[8], lty=2)
stdline(ne_arctic$wcatch,     lwd, col[9], to=14)
stdline(north_sea$wcatch,     lwd, col[10])
stdline(norway$wcatch,        lwd, col[11])
stdline(s_celtic$wcatch,      lwd, col[12])
stdline(w_baltic$wcatch,      lwd, col[13])
...
stdline(nafo_2j3kl$BPR,    lwd, col[6], lty=2)
stdline(nafo_3m$BPR,       lwd, col[7])
stdline(nafo_3no$BPR,      lwd, col[8], lty=2)
stdline(ne_arctic$BPR,     lwd, col[9], to=14)
stdline(north_sea$BPR,     lwd*1.5, col[10], to=3, lty=3)
stdline(north_sea$BPR,     lwd,     col[10], from=3)
stdline(norway$BPR,        lwd, col[11])
stdline(s_celtic$BPR,      lwd, col[12])
stdline(w_baltic$BPR,      lwd, col[13])
legend("topright", legend=stocks, bty="n", lty=1, lwd=lwd, col=col,
       inset=0.02, cex=0.8)
...
stdline(nafo_2j3kl$S,    lwd, col[6], lty=2)
stdline(nafo_3m$S,       lwd, col[7], from=4)
stdline(nafo_3no$S,      lwd, col[8], lty=2)
stdline(ne_arctic$S,     lwd, col[9], to=14)
stdline(north_sea$S,     lwd, col[10])
stdline(norway$S,        lwd, col[11])
stdline(s_celtic$S,      lwd, col[12])
stdline(w_baltic$S,      lwd, col[13])
legend("topright", legend=stocks, bty="n", lty=1, lwd=lwd, col=col,
       inset=0.02, cex=0.8)
box()
...
stdline(nafo_2j3kl$Cp,    lwd, col[6], lty=2)
stdline(nafo_3m$Cp,       lwd, col[7])
stdline(nafo_3no$Cp,      lwd, col[8], lty=2)
stdline(ne_arctic$Cp,     lwd, col[9], to=14)
stdline(north_sea$Cp,     lwd, col[10], to=8)
stdline(norway$Cp,        lwd, col[11])
stdline(s_celtic$Cp,      lwd, col[12])
stdline(w_baltic$Cp,      lwd, col[13])
legend("topright", legend=stocks, bty="n", lty=1, lwd=lwd, col=col,
       inset=0.02, cex=0.8)
box()
...
stdline(nafo_2j3kl$mat,    lwd, col[6], lty=2)
stdline(nafo_3m$mat,       lwd, col[7])
stdline(nafo_3no$mat,      lwd, col[8], lty=2)
stdline(ne_arctic$mat,     lwd, col[9], from=4, to=14)
stdline(north_sea$mat,     lwd, col[10])
stdline(norway$mat,        lwd, col[11])
stdline(s_celtic$mat,      lwd, col[12])
stdline(w_baltic$mat,      lwd, col[13])
