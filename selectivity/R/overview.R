...
lwd <- 2
stocks <- c("Celtic", "Faroe", "Georges Bank", "Greenland", "Gulf of Maine",
            "Iceland", "NAFO 2J3KL", "NAFO 3M", "NAFO 3NO", "NE Arctic",
            "North Sea", "Norway", "W Baltic")
...
stdline(celtic$Fmort,        lwd, col[1])
...
stdline(nafo_2j3kl$Fmort,    lwd, col[7])
stdline(nafo_3m$Fmort,       lwd, col[8])
stdline(nafo_3no$Fmort,      lwd, col[9])
...
stocks <- c("Celtic", "Faroe", "Georges Bank", "Greenland", "Gulf of Maine",
            "Iceland", "NAFO 3M", "NE Arctic", "North Sea", "Norway",
            "W Baltic")
col <- rich.colors(length(stocks))
...
stdline(celtic$wcatch,        lwd, col[1])
...
stdline(ne_arctic$wcatch,     lwd, col[8], to=14)
stdline(north_sea$wcatch,     lwd, col[9])
stdline(norway$wcatch,        lwd, col[10])
...
stdline(ne_arctic$BPR,     lwd, col[8], to=14)
stdline(north_sea$BPR,     lwd*1.5, col[9], to=3, lty=3)
stdline(north_sea$BPR,     lwd,     col[9], from=3)
stdline(norway$BPR,        lwd, col[10])
...
stdline(ne_arctic$S,     lwd, col[8], to=14)
stdline(north_sea$S,     lwd, col[9])
stdline(norway$S,        lwd, col[10])
...
stdline(ne_arctic$Cp,     lwd, col[8], to=14)
stdline(north_sea$Cp,     lwd, col[9], to=8)
stdline(norway$Cp,        lwd, col[10])
...
stdline(ne_arctic$mat,     lwd, col[8], from=4, to=14)
stdline(north_sea$mat,     lwd, col[9])
stdline(norway$mat,        lwd, col[10])
