...
out$Stock <- c("Eastern Baltic",
               ...
               "NAFO 3NO", "Northeast Arctic", "North Sea",
...
out$Label <- c('Eastern Baltic', "Faroe", "Georges", "Greenland", "Maine",
               "Iceland", "Irish",
               "2J3KL", "3M", "3NO", "NE Arctic", "North Sea", "Norway",
...
out <-
    ...
    mutate(Region = ifelse(Stock == 'Eastern Baltic', 'ns',
                    ...
                    ifelse(Stock == 'NAFO 2J3KL', 'nus',
                    ifelse(Stock == 'Gulf of Maine', 'nus',
                    ifelse(Stock == 'Georges Bank', 'nus',
                    ifelse(Stock == 'NAFO 3M', 'nus',
                    ifelse(Stock == 'NAFO 3NO', 'nus',
