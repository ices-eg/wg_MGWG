...
nafo_3ps <-
  list(N=N, Ninit=Ninit, wcatch=wcatch, wstock=wstock,
       C=C, Cp=Cp, Fmort=Fmort, S=S, mat=mat,
       SSB = SSB)


rm(ages, C, cohortBiomass, Cp, dims, Fmort, mat, minage, N, Ninit, path, plus,
   read, S, SSB, stdplot, wcatch, wstock, yrs)
