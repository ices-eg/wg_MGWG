...
stdline(ne_arctic$BPR,     lwd, col[6])
stdline(north_sea$BPR,     lwd, col[7])
...
stdline(nafo_2j3kl$S,    lwd, col[5])
stdline(ne_arctic$S,     lwd, col[6])
